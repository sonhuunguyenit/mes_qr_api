...
/**
 * Skeleton cho một item đơn lẻ trong danh sách.
 * Đã tinh chỉnh để khớp tuyệt đối với Layout thực tế (7 hàng Tag + Footer).
 */
const SupplierPotentialItemSkeleton = () => {
...
export default SupplierPotentialItemSkeleton;
