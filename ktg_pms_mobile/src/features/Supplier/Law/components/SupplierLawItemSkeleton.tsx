...
/**
 * Skeleton cho một item trong danh sách Chỉnh sửa pháp lý.
 * Clone hoàn toàn từ pattern PRItemSkeleton để đảm bảo khớp tuyệt đối.
 */
const SupplierLawItemSkeleton = () => {
...
export default SupplierLawItemSkeleton;
